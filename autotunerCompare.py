...
def stop_print(*args, **kwargs):
    return  # Do nothing
actual_print = print
print = stop_print  # Replace the built-in print with stop_print
...
def main() -> None:
    ...
    ### Actual prints to stdout
    actual_print(f"{args.player1} wins: {player1_wins}")  # best
    actual_print(f"{args.player2} wins: {player2_wins}")  # current
